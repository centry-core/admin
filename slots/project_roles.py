...
class Slot:  # pylint: disable=E1101,R0903
    ...
    @web.slot("roles_content")
    @auth.decorators.check_slot(["configuration.roles"], access_denied_reply=theme.access_denied_part)
    ...
    @auth.decorators.check_slot(["configuration.roles"])
